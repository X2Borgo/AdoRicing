...
Column {
    ...
    Component.onCompleted: {
        // Initialize with last user if ForceLastUser is enabled
    ...
    function setSelectedUser(usernameValue) {
    ...
    Item {
        ...
        visible: false
        height: 0
        width: 0  // Eliminate invisible spacing
    ...
    Item {
        ...
        TextField {
            ...
            // Cyberpunk glow effect when focused
            ...
            background: Rectangle {
                ...
                // Pulsing animation for cyberpunk effect
                SequentialAnimation on border.color {
                    running: password.activeFocus
                    loops: Animation.Infinite
                    ColorAnimation {
                        to: Qt.lighter(config.AccentColor, 1.3)
                        duration: 1000
                        easing.type: Easing.InOutQuad
                    }
                    ColorAnimation {
                        to: config.AccentColor
                        duration: 1000
                        easing.type: Easing.InOutQuad
                    }
                }
    ...
    // Spacer between login button and session selector
    Item {
        height: root.font.pointSize * 1.5
        width: parent.width
    }
