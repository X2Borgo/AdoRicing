...
- A Blender room-reconstruction side project used to live untracked at the repo root; it now resides at `~/Desktop/Room Reconstruction/` and is unrelated to this repo.
