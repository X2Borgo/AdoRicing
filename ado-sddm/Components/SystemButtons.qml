...
RowLayout {
    ...
    property Item exposedSession: null
    ...
    Repeater {
        ...
        RoundButton {
            ...
            transform: [
                Translate { id: hoverTranslate; y: 0 },
                Scale { 
                    id: pressScale
            ...
            onHoveredChanged: {
                if (hovered) {
                    ...
                    hoverTranslate.y = 0
                    pressScale.xScale = 1.0
                    pressScale.yScale = 1.0
                }
            }
            
            onPressedChanged: {
                if (pressed) {
                    pressScale.xScale = 0.98
                    pressScale.yScale = 0.98
                } else {
                    pressScale.xScale = 1.0
                    pressScale.yScale = 1.0
                }
            ...
            KeyNavigation.up: container.exposedSession
