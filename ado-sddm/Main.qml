...
Pane {
    ...
    Item {
        ...
        LoginForm {
            ...
            // --- CHANGE: Comment out the height line so it shrinks to fit content ---
            // height: virtualKeyboard.state == "visible" ? parent.height - virtualKeyboard.implicitHeight : parent.height
    
            // Optional: You might want to define a specific height if it vanishes, 
            // but usually implicitHeight works. If it disappears, try:
            // height: childrenRect.height

            width: parent.width / 2.5
    
            // ... your existing anchors ...
            anchors.right: config.FormPosition == "right" ? parent.right : undefined
    
            // --- Manual Positioning for Ado Theme (Proportional) ---
            anchors.bottom: parent.bottom
            anchors.bottomMargin: parent.height * 0.20  // 20% from bottom (moved up from 12%)
            anchors.rightMargin: parent.width * 0.08    // 8% from right, scales with resolution
            // -------------------------------------------------------
