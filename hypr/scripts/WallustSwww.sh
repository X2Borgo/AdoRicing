...
# Optional mode for fixed themes: keep wallpaper references updated,
# but skip palette/template regeneration from wallpaper colors.
if [[ "${ADO_KEEP_FIXED_PALETTE:-0}" == "1" ]]; then
  exit 0
fi
